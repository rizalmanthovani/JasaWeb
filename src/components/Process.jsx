...
const STEPS = [
  {
    ...
    desc: 'Ceritakan bisnis Anda — target pelanggan, kompetitor, dan tujuan website. Kami bantu analisis dan rekomendasikan solusi terbaik.',
    points: [
  ...
  },
  {
    ...
    desc: 'Kami kumpulkan semua aset — logo, foto, teks. Tim desainer mulai bangun tampilan website sesuai identitas dan karakter bisnis Anda.',
    points: [
  ...
  },
  {
    ...
    desc: 'Anda melihat hasilnya dan memberi feedback secara langsung. Kami lakukan revisi sampai tampilan dan konten benar-benar sesuai ekspektasi.',
    points: [
  ...
  },
  {
    ...
    desc: 'Website resmi live di domain Anda dengan SSL aktif. Kami setup semua konfigurasi teknis dan standby 30 hari untuk support penuh.',
    points: [
      ...
      >
        ...
        <div className="relative z-10 p-6">
          ...
          >
            ...
            <div>
              <span className="font-body text-[10px] text-[#555555] block leading-tight">Anda mendapatkan:</span>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="font-body text-[#BBBBBB] text-base max-w-lg mx-auto">
            Proses kerja kami transparan di setiap tahap. Anda tahu persis apa yang terjadi, kapan selesai, dan apa yang Anda dapatkan.
          </p>
        </div>
